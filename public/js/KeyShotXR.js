...
window.keyshotXR = function (
  ...
  this.va = function (b, f) {
    return path + "/" + parseInt(f) + "_" + parseInt(b) + "." + Ea;
  };
  ...
  this.ua = function () {
    ...
    a.o.innerHTML = '<img src="' + "/keyshotAssets/" + d + '"></img>';
    a.p.appendChild(a.o);
    a.p.appendChild(a.Q);
    n.appendChild(a.p);
    a.v(a.i);
  ...
  if (document.createElement("canvas").getContext) {
    ...
    Da &&
      ...
      a.i
        ? a.H.setAttribute("src", "/keyshotAssets/GoFullScreenIcon.png")
        : a.H.setAttribute("src", "/keyshotAssets/GoFixedSizeIcon.png"),
      a.H.setAttribute(
        "style",
    ...
    if (a.W) {
      ...
      K
        ? a.X.setAttribute("src", "/keyshotAssets/xr_hand.gif")
        : a.X.setAttribute("src", "/keyshotAssets/xr_cursor.gif");
      a.X.setAttribute(
        "style",
